...
use regressions_342::REGRESSION_CASES_342;
use regressions_343::REGRESSION_CASES_343;
use regressions_344::REGRESSION_CASES_344;
use regressions_345::REGRESSION_CASES_345;
use regressions_346::REGRESSION_CASES_346;
use regressions_347::REGRESSION_CASES_347;
use regressions_348::REGRESSION_CASES_348;
use regressions_349::REGRESSION_CASES_349;
use regressions_350::REGRESSION_CASES_350;
use regressions_351::REGRESSION_CASES_351;
use regressions_352::REGRESSION_CASES_352;
use regressions_353::REGRESSION_CASES_353;
use regressions_354::REGRESSION_CASES_354;
use regressions_355::REGRESSION_CASES_355;
use regressions_356::REGRESSION_CASES_356;
use regressions_357::REGRESSION_CASES_357;
use regressions_358::REGRESSION_CASES_358;
use regressions_359::REGRESSION_CASES_359;
use regressions_360::REGRESSION_CASES_360;
use regressions_361::REGRESSION_CASES_361;
use regressions_362::REGRESSION_CASES_362;
use regressions_363::REGRESSION_CASES_363;
use regressions_364::REGRESSION_CASES_364;
use regressions_365::REGRESSION_CASES_365;
use regressions_366::REGRESSION_CASES_366;
use regressions_367::REGRESSION_CASES_367;
use regressions_368::REGRESSION_CASES_368;
use regressions_369::REGRESSION_CASES_369;
use regressions_370::REGRESSION_CASES_370;
use regressions_371::REGRESSION_CASES_371;
use regressions_373::REGRESSION_CASES_373;
use regressions_374::REGRESSION_CASES_374;
use regressions_375::REGRESSION_CASES_375;
use regressions_376::REGRESSION_CASES_376;
use regressions_377::REGRESSION_CASES_377;
use regressions_378::REGRESSION_CASES_378;
use regressions_379::REGRESSION_CASES_379;
use regressions_380::REGRESSION_CASES_380;
use regressions_381::REGRESSION_CASES_381;
use regressions_382::REGRESSION_CASES_382;
use regressions_383::REGRESSION_CASES_383;
use regressions_384::REGRESSION_CASES_384;
use regressions_385::REGRESSION_CASES_385;
use regressions_386::REGRESSION_CASES_386;
use regressions_387::REGRESSION_CASES_387;
use regressions_388::REGRESSION_CASES_388;
use regressions_389::REGRESSION_CASES_389;
use regressions_390::REGRESSION_CASES_390;
use regressions_391::REGRESSION_CASES_391;
use regressions_392::REGRESSION_CASES_392;
use regressions_393::REGRESSION_CASES_393;
use regressions_394::REGRESSION_CASES_394;
use regressions_395::REGRESSION_CASES_395;
use regressions_396::REGRESSION_CASES_396;
use regressions_397::REGRESSION_CASES_397;
use regressions_398::REGRESSION_CASES_398;
use regressions_399::REGRESSION_CASES_399;
use regressions_400::REGRESSION_CASES_400;
use regressions_401::REGRESSION_CASES_401;
use regressions_402::REGRESSION_CASES_402;
use regressions_403::REGRESSION_CASES_403;
use regressions_404::REGRESSION_CASES_404;
use regressions_405::REGRESSION_CASES_405;
...
pub(crate) fn regression_cases() -> impl Iterator<Item = LuaCaseManifestEntry> {
    [
        ...
        REGRESSION_CASES_342,
        REGRESSION_CASES_343,
        REGRESSION_CASES_344,
        REGRESSION_CASES_345,
        REGRESSION_CASES_346,
        REGRESSION_CASES_347,
        REGRESSION_CASES_348,
        REGRESSION_CASES_349,
        REGRESSION_CASES_350,
        REGRESSION_CASES_351,
        REGRESSION_CASES_352,
        REGRESSION_CASES_353,
        REGRESSION_CASES_354,
        REGRESSION_CASES_355,
        REGRESSION_CASES_356,
        REGRESSION_CASES_357,
        REGRESSION_CASES_358,
        REGRESSION_CASES_359,
        REGRESSION_CASES_360,
        REGRESSION_CASES_361,
        REGRESSION_CASES_362,
        REGRESSION_CASES_363,
        REGRESSION_CASES_364,
        REGRESSION_CASES_365,
        REGRESSION_CASES_366,
        REGRESSION_CASES_367,
        REGRESSION_CASES_368,
        REGRESSION_CASES_369,
        REGRESSION_CASES_370,
        REGRESSION_CASES_371,
        REGRESSION_CASES_373,
        REGRESSION_CASES_374,
        REGRESSION_CASES_375,
        REGRESSION_CASES_376,
        REGRESSION_CASES_377,
        REGRESSION_CASES_378,
        REGRESSION_CASES_379,
        REGRESSION_CASES_380,
        REGRESSION_CASES_381,
        REGRESSION_CASES_382,
        REGRESSION_CASES_383,
        REGRESSION_CASES_384,
        REGRESSION_CASES_385,
        REGRESSION_CASES_386,
        REGRESSION_CASES_387,
        REGRESSION_CASES_388,
        REGRESSION_CASES_389,
        REGRESSION_CASES_390,
        REGRESSION_CASES_391,
        REGRESSION_CASES_392,
        REGRESSION_CASES_393,
        REGRESSION_CASES_394,
        REGRESSION_CASES_395,
        REGRESSION_CASES_396,
        REGRESSION_CASES_397,
        REGRESSION_CASES_398,
        REGRESSION_CASES_399,
        REGRESSION_CASES_400,
        REGRESSION_CASES_401,
        REGRESSION_CASES_402,
        REGRESSION_CASES_403,
        REGRESSION_CASES_404,
        REGRESSION_CASES_405,
