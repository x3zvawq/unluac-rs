...
fn analyze_debug_bindings(
    proto: &LoweredProto,
    cfg: &Cfg,
    dataflow: &DataflowFacts,
) -> DebugBindingFacts {
    let mut by_value = BTreeMap::<super::SsaValue, Vec<usize>>::new();
...
fn low_instr_at_or_after_pc(proto: &LoweredProto, pc: u32) -> Option<InstrRef> {
    proto
        .lowering_map
        .pc_map
        .iter()
...
fn ssa_value_at_debug_scope_entry(
    proto: &LoweredProto,
    cfg: &Cfg,
    dataflow: &DataflowFacts,
    instr: InstrRef,
